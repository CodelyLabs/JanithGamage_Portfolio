...
function Chemistry() {
  return (
    <>
      {/* Wrapper to Extend #FFEBEB Background */}
      <div className="bg-[#FFEBEB]">
        ...
        <div
          className="text-[#2D2D2D] text-center py-4"
          style={{
          ...
          <div className="max-w-5xl mx-auto px-6 sm:px-10">
            <p className="text-xl font-medium mb-4">
              ...
              <span className="block mt-4">
                නූතනයේ ඇති තරඟකාරී විභාගය වන අපොස උසස් පෙළ විභාගය ජය ගැනීමට මෙහි ඇති මේවලම් ඉවහල් වනු ඇත.
              </span>
              <span className="block mt-4">
      ...
      {/* Card Section (Outside FFEBEB Background) */}
      <div className="mt-8">
        <Card />
      </div>
    </>
